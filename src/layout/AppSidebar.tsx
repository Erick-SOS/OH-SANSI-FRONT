...
const AppSidebar: React.FC = () => {
  ...
  return (
    <>
      ...
      <aside className={`
        fixed lg:sticky top-0 left-0 h-dvh lg:h-full z-50
        flex flex-col bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800
        transition-all duration-300 overflow-y-auto scrollbar-gutter-stable
      ...
      `}>
        ...
        <nav className="flex-1 overflow-y-auto px-5 pb-10">
          <h2 className={`mb-4 text-xs uppercase text-gray-500 dark:text-gray-400 ${!isExpanded && !isHovered ? "lg:text-center" : ""}`}>
