...
const ResultadosDeCalificaciones: React.FC = () => {
  ...
  const generarResultados = () => {
    ...
    pruebas.forEach(prueba => {
      ...
      else if (puntuacion >= 70) calificacion = "Bueno";
  ...
  const obtenerMensajeAprobacion = () => {
    ...
    if (puntuacionTotal >= 70) return "¡Bien! Aprobado satisfactoriamente";
    if (puntuacionTotal >= 51) return "Aprobado";
    return "No Aprobado";
  };

  const obtenerClaseAprobacion = () => {
    if (puntuacionTotal >= 70) return "text-green-600 bg-green-50 border-green-200";
    if (puntuacionTotal >= 51) return "text-yellow-600 bg-yellow-50 border-yellow-200";
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <header className="text-center mb-8">
          <div className="flex justify-center items-center mb-4">
            ...
            <h1 className="text-3xl font-bold text-gray-800">Consulta de Calificaciones y Resultados</h1>
          </div>
        </header>
          ...
          <div className="p-6">
            <div className="space-y-6">
              ...
              <button
                ...
                className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-6 rounded-lg transition duration-200 transform hover:-translate-y-1 shadow-lg"
              >
              ...
              <div className="bg-gray-50 rounded-lg p-6 mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-lg">{nivel}</p>
                  </div>
                  <div>
              ...
              {obtenerMejorPosicion() <= 3 && (
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
                  <div className="flex items-center">
                    <i className="fas fa-trophy text-yellow-500 text-2xl mr-3"></i>
                    <div>
                      <strong className="text-yellow-800 text-lg">
                        ¡Felicidades! Has obtenido el {obtenerMejorPosicion()}° lugar
                      </strong>
                      <p className="text-yellow-700">
                        {obtenerMejorPosicion() === 1 
                          ? "¡Medalla de Oro!" 
                          : obtenerMejorPosicion() === 2 
                          ? "¡Medalla de Plata!" 
                          : "¡Medalla de Bronce!"}
                      </p>
                    </div>
